...
- **Une collaboration continue avec la Ville de Mulhouse (m2A)**
  - Interlocutrice dédiée : la responsable de la gestion des piscines de l'agglomération ; co-construction basée sur la confiance.
...
- **3. Recette municipale :** Phase de test en conditions réelles par la cliente et ses équipes d'agents.
...
- **Traçabilité formalisée :** Publication systématique de **Notes de version Linear** et du **Changelog GitHub** pour chaque jalon.

</v-clicks>

<!--
"La relation avec la Ville de Mulhouse s'est construite sur une boucle de validation très réactive."

[click] Une interlocutrice clé : La responsable des piscines de l'agglomération (m2A), impliquée au quotidien.

[click] Cadrage amont : En début de sprint, consultation par mail ou visio pour confirmer que nos priorités répondent à ses besoins immédiats.

[click] Démo de sprint : En fin de sprint, démonstration live sur notre environnement de préproduction.

[click] Recette municipale : La cliente teste avec son équipe d'agents en mairie et en caisse.

[click] Boucle de feedback : Si un retour est légitime, de notre fait et réalisable dans les temps impartis, nous le corrigeons, retestons et déployons en production.

[click] Traçabilité : Chaque livraison est accompagnée de son changelog GitHub et de ses notes de version officielles sur Linear.
...
<!--
"Voici les indicateurs clés attestant de la satisfaction de la collectivité."

[click] 100% d'acceptation : L'ensemble des fonctionnalités majeures ont été validées sans réserve lors des revues de sprint.

[click] Réactivité sous 48h : Prise en compte et résolution immédiate des anomalies signalées pendant les recettes clientes.

[click] Zéro crash en production : La plateforme a encaissé sans aucune indisponibilité les vagues d'inscriptions scolaires et estivales sur e-services.mulhouse-alsace.fr.

[click] Adhésion des agents : Les agents municipaux ont immédiatement plébiscité le gain de temps sur la réservation et la consultation des jauges par rapport à l'ancien outil.
...
<!--
"Pour cette démonstration de 5 minutes, nous allons valider la synchronisation temps réel de bout en bout."

[click] Acte 1 - Côté Citoyen (Aqua Mulhouse) : Consultation des offres de bassins, choix du créneau horaire, panier, ajout d'un voucher de réduction et validation du paiement PayFIP simulé.

[click] Acte 2 - Côté Agent (Shop Back-Office) : Consultation de la liste via notre DataTable bi-mode, réservation 'En tant que' pour un usager au guichet, et contrôle immédiat de la commande passée à l'instant en ligne.
...
<!--
"Nous voici en direct sur notre plateforme de préproduction mulhouse4.staging.numesia.fr."
...
- **Bilan opérationnel & Produit pérenne**
...
- **Posture de Lead : Pragmatisme & Arbitrage équilibré**
  - Privilégier la démonstration par la preuve (POC) plutôt que l'affrontement dogmatique.
  - Savoir concilier pureté technique, réalité budgétaire et contraintes de délais.
- **Fédération d'équipe & Dynamique humaine**
  - Aligner les compétences et les passions pour maintenir l'engagement durable.
  - Partage transparent des décisions pour responsabiliser chacun.

</v-clicks>

<!--
"Pour conclure cette présentation, que retenir de cette expérience de coordination ?"

[click] Succès produit : Logitud dispose désormais d'un moteur e-commerce générique scalable, et Mulhouse d'un service public moderne et stable, avec 25 sprints menés sans dérive.

[click] Posture de Lead : J'ai appris que coordonner ne consiste pas à imposer sa technique, mais à écouter, à trancher par la preuve factuelle (le POC), et à trouver le compromis intelligent entre idéal technique et contrainte budgétaire.

[click] Fédération de l'équipe : En respectant les appétences des développeurs et en partageant les décisions avec transparence, on crée un collectif soudé et performant dans la durée.
...
<!--
"Merci à tous les deux. Je suis à votre entière écoute pour vos questions."
