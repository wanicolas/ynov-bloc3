...
- **Accessibilité numérique (RGAA) : Une analyse critique lucide**
  ...
  - _Décision d'arbitrage :* Abandon d'un audit formel complet RGAA ; sécurisation maximale du Front Usager via les composants natifs accessibles de **NuxtUI** et un soin particulier sur le tunnel de commande.
